...
/**
 * Strings (English) for block_autobackup.
 *
...
$string['pluginname'] = 'Autobackup';
$string['autobackup:addinstance'] = 'Añadir un nuevo bloque autobackup de actividades';
$string['autobackup:generate'] = 'Descargar un backup de la actividad';
